...
product1 = Product.create({name: "Queso", price: 80, unit: "kg", stock: 100})
product2 = Product.create({name: "Huevos", price: 25, unit: "u", stock: 100})
product3 = Product.create({name: "Marineras", price: 50, unit: "u", stock: 100})
product4 = Product.create({name: "Milanesas", price: 150, unit: "kg", stock: 100})
product5 = Product.create({name: "Alitas", price: 80, unit: "kg", stock: 100})
product6 = Product.create({name: "Pechuga", price: 180, unit: "kg", stock: 100})
product7 = Product.create({name: "Pata y muslo", price: 150, unit: "kg", stock: 100})
