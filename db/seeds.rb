...
Product.create({name: "Milanesas", price: 150, unit: "kg", promotion_price: 150, stock: 100})
Product.create({name: "Alitas", price: 80, unit: "kg", promotion_price: 80, stock: 100})
Product.create({name: "Pechuga", price: 180, unit: "kg", promotion_price: 180, stock: 100})
Product.create({name: "Pata y muslo", price: 150, unit: "kg", promotion_price: 150, stock: 100})
